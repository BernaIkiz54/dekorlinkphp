        ...
        <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="350" valign="top"><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="border: 1px solid #CCCCCC;" align="center"><img id="BuyukResim" src="Resimler/UrunResimleri/<?php echo $kategori; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>" width="330" height="440" border="0"></td>
                        </tr>
                        <tr height="5">
                        ...
                        <tr>
                            <td><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="78" style="border: 1px solid #CCCCCC;"><img src="Resimler/UrunResimleri/<?php echo $kategori; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $kategori; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>');"></td>
                                        <td width="10">&nbsp;</td>
                                        <?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"])!=""){ ?><td width="78" style="border: 1px solid #CCCCCC;"><img src="Resimler/UrunResimleri/<?php echo $kategori; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $kategori; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"]); ?>');"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
                                        <td width="10">&nbsp;</td>
                                        <?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"])!=""){ ?><td width="78" style="border: 1px solid #CCCCCC;"><img src="Resimler/UrunResimleri/<?php echo $kategori; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $kategori; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"]); ?>');"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
                                        <td width="10">&nbsp;</td>
                                        <?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]!="")){ ?><td width="78" style="border: 1px solid #CCCCCC;"><img src="Resimler/UrunResimleri/<?php echo $kategori; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $kategori; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]); ?>');"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
                                    </tr>
                                </table></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    ?>
                                    <tr height="350">
                                        <td><img height="350" width="350" src="Resimler/Banner/<?php echo DonusumleriGeriDondur($BannerKaydi["BannerResmi"]); ?>" border="0"></td>
                                    </tr>
                                    <?php
                                        ...
                                        <tr height="45">
                                            <td colspan="5"><table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr height="45">
                                                        ...
                                                        <td width="205" align="right" style="font-size: 25px; color: black; font-weight: bold;"><?php echo FiyatBicimlendir($UrunSorgusuKaydi["fiyat"]); ?> TL</td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                    </table></form></td>
