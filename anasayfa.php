<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                ?>
                <tr height="186">
                    <td><img width="1065" height="186" src="Resimler/Banner/<?php echo $BannerKaydi["BannerResmi"]; ?>" border="0"></td>
                </tr>
                <?php
    ...
    <tr>
        <td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr><?php
                    $EnYeniUrunlerSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT *,urun.id as ID,kategori_adi as kategori FROM urun,kategori WHERE urun.kategori_id=kategori.id AND Durumu = '0' ORDER BY urun.id DESC LIMIT 5");
                    ...
                    foreach($EnYeniUrunKayitlari as $EnYeniUrunSatirlari){
                        $EnYeniUrununTuru		=	DonusumleriGeriDondur($EnYeniUrunSatirlari["kategori"]);
                        $EnYeniUrununAdi		=	DonusumleriGeriDondur($EnYeniUrunSatirlari["urun_adi"]);
                        $EnYeniUrununFiyati		=	DonusumleriGeriDondur($EnYeniUrunSatirlari["fiyat"]);
                        $EnYeniUrununParaBirimi	=	"TL";
                        ...
                        <td width="205" valign="top">
                            <table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px; border-top:1px solid; border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; border-color: #CCCCCC; ">
                                <tr height="40">
                                    <td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["ID"]); ?>"><img src="Resimler/UrunResimleri/<?php echo $EnYeniUrunSatirlari["kategori"]; ?>/<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["UrunResmiBir"]); ?>" border="0" width="205" height="273"></a></td>
                                </tr>
                                <tr height="25">
                                ...
                                <tr height="25">
                                    <td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["ID"]); ?>" style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo DonusumleriGeriDondur($EnYeniUrununAdi); ?></a></td>
                                </tr>
                                <tr height="25">
    ...
    <tr>
        <td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr><?php
                    $EnPopulerUrunlerSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT *,kategori_adi as kategori FROM urun,kategori WHERE urun.kategori_id=kategori.id AND Durumu = '0' ORDER BY urun.GoruntulenmeSayisi DESC LIMIT 5");
                    ...
                    foreach($EnPopulerUrunKayitlari as $EnPopulerUrunSatirlari){
                        $EnPopulerUrununTuru		=	DonusumleriGeriDondur($EnPopulerUrunSatirlari["kategori"]);
                        $EnPopulerUrununFiyati		=	DonusumleriGeriDondur($EnPopulerUrunSatirlari["fiyat"]);
                        ...
                        ?>
                        <td width="205" valign="top" style="border-top:1px solid; border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; border-color: #CCCCCC; ">
                            <table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
                                <tr height="40">
                                    <td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["ID"]); ?>"><img src="Resimler/UrunResimleri/<?php echo $EnPopulerUrunSatirlari["kategori"]; ?>/<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["UrunResmiBir"]); ?>" border="0" width="205" height="273"></a></td>
                                </tr>
                                <tr height="25">
                                ...
                                <tr height="25">
                                    <td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["ID"]); ?>" style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo $EnPopulerUrunSatirlari["fiyat"]; ?> TL</a></td>
                                </tr>
                            </table>
                        </td>
                        <?php
    ...
    <tr>
        <td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0" >
                <tr><?php
                    $EnCokSatanUrunlerSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT *,kategori_adi as kategori FROM urun,kategori WHERE urun.kategori_id=kategori.id AND Durumu = '0' ORDER BY ToplamSatisSayisi DESC LIMIT 5");
                    ...
                    foreach($EnCokSatanUrunKayitlari as $EnCokSatanUrunSatirlari){
                        $EnCokSatanUrununTuru		=	DonusumleriGeriDondur($EnCokSatanUrunSatirlari["kategori"]);
                        $EnCokSatanUrununFiyati		=	DonusumleriGeriDondur($EnCokSatanUrunSatirlari["fiyat"]);
                        ...
                        <td width="205" valign="top" style="border-top:1px solid; border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; border-color: #CCCCCC; ">
                            <table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
                                <tr height="40">
                                    <td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["ID"]); ?>"><img src="Resimler/UrunResimleri/<?php echo $EnCokSatanUrunSatirlari["kategori"]; ?>/<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["UrunResmiBir"]); ?>" border="0" width="205" height="273"></a></td>
                                </tr>
                                <tr height="25">
                                ...
                                <tr height="25">
                                    <td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["ID"]); ?>" style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo FiyatBicimlendir($EnCokSatanUrunSatirlari["fiyat"]); ?> TL</a></td>
                                </tr>
                            </table>
                        </td>
                        <?php
