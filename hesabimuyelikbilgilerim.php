        ...
        <tr>
            <td width="500" valign="top">
                <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="30">
                        <td valign="top" align="left"><?php echo $KayitTarihi; ?></td>
                    </tr>
                    <tr height="30">
            ...
            <td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="30">
                        <td valign="top" style="border-bottom: 1px dashed #CCCCCC;">DEKORLİNK Reklamları.</td>
                    </tr>
                    <tr height="5">
                        <td height="5" style="font-size: 5px;">&nbsp;</td>
                    </tr>
                    <tr>
                        <td><img width="545" height="260" src="Resimler/545x340Reklam.jpg" border="0"></td>
                    </tr>
                </table></td>
        </tr>
    </table>
