...
if(isset($_SESSION["Yonetici"])){
	if(isset($_REQUEST["AramaIcerigi"])){
		...
		$AramaKosulu		=	 " AND (email LIKE '%" . $GelenAramaIcerigi . "%' OR ad_soyad LIKE '%" . $GelenAramaIcerigi . "%' OR TelNo LIKE '%" . $GelenAramaIcerigi . "%' ) ";
	...
	$ToplamKayitSayisiSorgusu				=	$VeritabaniBaglantisi->prepare("SELECT * FROM uyeler WHERE aktif_mi = ? $AramaKosulu ORDER BY uyeID DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$UyelerSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT * FROM uyeler WHERE aktif_mi = ? $AramaKosulu ORDER BY uyeID DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
	...
	?>	
			<tr height="80">
                <td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                        <tr height="30">
                            <td width="80"><b>Adı Soyadı</b></td>
                            <td width="10"><b>:</b></td>
                            <td width="100"><?php echo DonusumleriGeriDondur($Uyeler["ad_soyad"]); ?></td>
                            <td width="60"><b>E-Mail</b></td>
                            <td width="10"><b>:</b></td>
                            <td width="140"><?php echo DonusumleriGeriDondur($Uyeler["email"]); ?></td>
                        ...
                        <tr height="30">
                            ...
                            <td width="10"><b>:</b></td>
                            <td width="95"><?php echo DonusumleriGeriDondur($Uyeler["TelNo"]); ?></td>
                            <td width="80"><b>Kayıt Tarihi</b></td>
                            <td><b>:</b></td>
                            <td><?php echo  DonusumleriGeriDondur($Uyeler["olusturma_tarihi"]); ?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="9" align="right"><table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="20">&nbsp;</td>
                                        <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=87&ID=<?php echo DonusumleriGeriDondur($Uyeler["uyeID"]); ?>"><img src="../Resimler/Guncelleme20x20.png" border="0" style="margin-top: 5px;"></a></td>
                                        <td width="50" align="left"><a href="index.php?SKD=0&SKI=87&ID=<?php echo DonusumleriGeriDondur($Uyeler["uyeID"]); ?>" style="color: #009900; text-decoration: none;">Geri Aç</a></td>
                                    </tr>
                                </table></td>
                        </tr>
