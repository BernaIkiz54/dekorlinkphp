...
if (isset($_SESSION["Yonetici"])) {
    ...
    $SayfaBasinaGosterilecekKayitSayisi = 7;
    ...
    <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr height="70">
            ...
            <td width="200" bgcolor="#FF9900" align="right"><a href="index.php?SKD=0&SKI=83"
                                                               style="color: #FFFFFF; text-decoration: none;">Silinmiş
                    Üyeler&nbsp;</a></td>
        </tr>
        <tr height="10">
                    ...
                    <td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top">
                        <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                            <tr height="30">
                                ...
                                <td width="10"><b>:</b></td>
                                <td width="150"><?php echo DonusumleriGeriDondur($Uyeler["ad_soyad"]); ?></td>
                                <td width="90"><b>E-Mail</b></td>
                                <td width="10"><b>:</b></td>
                                <td width="200"><?php echo DonusumleriGeriDondur($Uyeler["email"]); ?></td>
                                    ...
                                    <table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="25" valign="top" align="left"><a
                                                        href="index.php?SKD=0&SKI=84&ID=<?php echo DonusumleriGeriDondur($Uyeler["uyeID"]); ?>"><img
                                                            src="../Resimler/Sil20x20.png" border="0"
                                                            style="margin-top: 5px;"></a></td>
                                            <td width="30" align="left"><a
                                                        href="index.php?SKD=0&SKI=84&ID=<?php echo DonusumleriGeriDondur($Uyeler["uyeID"]); ?>"
