			...
			<td colspan="2"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					...
					<td width="500"><select name="UrunMenusu" class="SelectAlanlari">
						...
						<?php
						$MenulerSorgusu			=	$VeritabaniBaglantisi->prepare("SELECT * FROM kategori ");
						...
						?>
							<option value="<?php echo  DonusumleriGeriDondur($MenuKaydi["id"]); ?>"><?php echo  DonusumleriGeriDondur($MenuKaydi["kategori_adi"]); ?></option>
						<?php
						}
						?>
					</select></td>
				...
				<tr height="40">
                 ...
                 <tr height="40">
                        <td>Çok Satan Ürün</td>
                        <td>:</td>
                        <td><input type="checkbox" name="CokSatan" value="1">Evet</input></td>
                 </tr>

                 <tr height="40">
                        <td>Öne Çıkan Ürün</td>
                        <td>:</td>
                        <td><input type="checkbox" name="OneCikan" value="1">Evet</input></td>
                 </tr>
                    <tr height="40">
                        <td>İndirimli Ürün</td>
                        <td>:</td>
                        <td><input type="checkbox" name="Indirimli" value="1">Evet</input></td>
                    </tr>
