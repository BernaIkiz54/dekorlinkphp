...
if(isset($_SESSION["Yonetici"])){
	...
	$ToplamKayitSayisiSorgusu				=	$VeritabaniBaglantisi->prepare("SELECT * FROM urun WHERE Durumu = ? $AramaKosulu ORDER BY id DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$UrunlerSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT * FROM urun WHERE Durumu = ? $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
	...
	if($UrunlerSayisi>0){
		foreach($UrunlerKayitlari as $Urunler){
			$UrununMenuSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT * FROM kategori WHERE id = ? LIMIT 1");
		...
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="680" valign="top"><table width="680" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="25">
						<td width="580"><?php echo DonusumleriGeriDondur($Urunler["urun_adi"]); ?></td>
						</tr>
					<tr height="25">
