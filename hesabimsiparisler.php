        ...
        <tr>
            <td width="1065" valign="top">
                <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="30">
                        <td colspan="8" valign="top" style="border-bottom: 1px dashed #CCCCCC;">Tüm Siparişlerinizi Bu
                            Alandan Görüntüleyebilirsiniz.
                        </td>
                    </tr>
                    <tr height="50">
                        <td width="125" style="background: #f8ffa7; color: black;" align="left">&nbsp;Sipariş Numarası
                        </td>
                        ...
                        <td width="150" style="background: #f8ffa7; color: black;" align="left">Kargo Durumu / Takip
                        </td>
                    </tr>
                    <?php
                    ...
                    if ($SiparisNumaralariSayisi > 0) {
                        foreach ($SiparisNumaralariKayitlari as $SiparisNumaralariSatirlar) {
                            ...
                            foreach ($SiparisSorgusuKayitlari as $SiparisSatirlar) {
                                ...
                                if ($UrunTuru == "Ampüller ve Led Ürünleri") {
                                    $ResimKlasoruAdi = "Ampüller ve Led Ürünleri";
                                } elseif ($UrunTuru == "Avizeler") {
                                    $ResimKlasoruAdi = "Avizeler";
                                } elseif ($UrunTuru == "Aynalar") {
                                    $ResimKlasoruAdi = "Aynalar";
                                } elseif ($UrunTuru == "bardak ve Sürahiler") {
                                    $ResimKlasoruAdi = "bardak ve Sürahiler";
                                } elseif ($UrunTuru == "Çatal Kaşık") {
                                    $ResimKlasoruAdi = "Çatal Kaşık";
                                } elseif ($UrunTuru == "Dekoratif Obje") {
                                    $ResimKlasoruAdi = "Dekoratif Obje";
                                } elseif ($UrunTuru == "Kapı Önü Aksesuarları") {
                                    $ResimKlasoruAdi = "Kapı Önü Aksesuarları";
                                } elseif ($UrunTuru == "Kitaplık") {
                                    $ResimKlasoruAdi = "Kitaplık";
                                } elseif ($UrunTuru == "Led Aydınlatmalar") {
                                    $ResimKlasoruAdi = "Led Aydınlatmalar";
                                } elseif ($UrunTuru == "Oturma Odası") {
                                    $ResimKlasoruAdi = "Oturma Odası";
                                } elseif ($UrunTuru == "Saklama Kapları") {
                                    $ResimKlasoruAdi = "Saklama Kapları";
                                } elseif ($UrunTuru == "Sarkıtlar") {
                                    $ResimKlasoruAdi = "Sarkıtlar";
                                } elseif ($UrunTuru == "Sehpa") {
                                    $ResimKlasoruAdi = "Sehpa";
                                } elseif ($UrunTuru == "Servis Ürünleri") {
                                    $ResimKlasoruAdi = "Servis Ürünleri";
                                } elseif ($UrunTuru == "Spot Lambaları") {
                                    $ResimKlasoruAdi = "Spot Lambaları";
                                } elseif ($UrunTuru == "Tablo") {
                                    $ResimKlasoruAdi = "Tablo";
                                } elseif ($UrunTuru == "Tv Ünitesi") {
                                    $ResimKlasoruAdi = "Tv Ünitesi";
                                } elseif ($UrunTuru == "Yatak Odası") {
                                ...
                                <tr height="30">
                                    <td width="125" align="left">
                                        &nbsp;#<?php echo DonusumleriGeriDondur($SiparisSatirlar["SiparisNumarasi"]); ?></td>
                                    ...
                                    <td width="50" align="left"><a
                                                href="index.php?SK=75&UrunID=<?php echo DonusumleriGeriDondur($SiparisSatirlar["UrunId"]); ?>"><img
                                    ...
                                    <td width="100"
                                        align="left"><?php echo FiyatBicimlendir(DonusumleriGeriDondur($SiparisSatirlar["UrunFiyati"])); ?>
                                        TL
                                    </td>
                                    <td width="50"
                                        align="left"><?php echo DonusumleriGeriDondur($SiparisSatirlar["UrunAdedi"]); ?></td>
                                    <td width="100"
                                        align="left"><?php echo FiyatBicimlendir(DonusumleriGeriDondur($SiparisSatirlar["ToplamUrunFiyati"])); ?>
                                        TL
                                    </td>
