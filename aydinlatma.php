...
if ($GelenMenuId != "") {
    $ToplamKayitSayisiSorgusu = $VeritabaniBaglantisi->prepare("SELECT *  FROM urun,kategori WHERE  urun.kategori_id=kategori.id AND kategori.ust_id=20 AND kategori.id=$GelenMenuId $AramaKosulu  ORDER BY kategori.id DESC");
    $ToplamKayitSayisiSorgusu->execute();
    $ToplamKayitSayisiSorgusu = $ToplamKayitSayisiSorgusu->rowCount();
    $SayfalamayaBaslanacakKayitSayisi = ($Sayfalama * $SayfaBasinaGosterilecekKayitSayisi) - $SayfaBasinaGosterilecekKayitSayisi;
    $BulunanSayfaSayisi = ceil($ToplamKayitSayisiSorgusu / $SayfaBasinaGosterilecekKayitSayisi);
} else {
    $ToplamKayitSayisiSorgusu = $VeritabaniBaglantisi->prepare("SELECT *  FROM urun,kategori WHERE  urun.kategori_id=kategori.id AND kategori.ust_id=20  $AramaKosulu  ORDER BY kategori.id DESC");
    $ToplamKayitSayisiSorgusu->execute();
    $ToplamKayitSayisiSorgusu = $ToplamKayitSayisiSorgusu->rowCount();
    $SayfalamayaBaslanacakKayitSayisi = ($Sayfalama * $SayfaBasinaGosterilecekKayitSayisi) - $SayfaBasinaGosterilecekKayitSayisi;
    $BulunanSayfaSayisi = ceil($ToplamKayitSayisiSorgusu / $SayfaBasinaGosterilecekKayitSayisi);
}
$AnaMenununTumUrunSayiSorgusu = $VeritabaniBaglantisi->prepare("SELECT Count(*) AS MenununToplamUrunu FROM urun,kategori WHERE urun.kategori_id=kategori.id AND kategori.ust_id=20");
                ...
                <tr>
                    <td>
                        <table width="250" align="center" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <?php
                            $MenulerSorgusu = $VeritabaniBaglantisi->prepare("SELECT id,kategori_adi FROM kategori WHERE ust_id=20 ORDER BY kategori_adi ASC");
                            ...
                            foreach ($MenuKayitlari as $Menu) {
                                ...
                                ?>
                                <tr height="30">
                                    <td><a href="index.php?SK=107&MenuID=<?php echo $Menu["id"]; ?>"
                ...
                <tr>
                    <td>
                        <div class="AramaAlani">
                            <form action="index.php?SK=107" method="post">
                                <?php
                                if ($GelenMenuId != "") {
                                    ?>
                        ...
                        <td align="center">
                            <div class="SayfalamaAlaniKapsayicisi">
                                ...
                                <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                                    <?php
                                    if ($Sayfalama > 1) {
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=107" . $SayfalamaKosulu . "&SYF=1'><<</a></span>";
                                        $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama - 1;
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=107" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
                                    }
                                    ...
                                    for ($SayfalamaIcinSayfaIndexDegeri = $Sayfalama - $SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri <= $Sayfalama + $SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++) {
                                        if (($SayfalamaIcinSayfaIndexDegeri > 0) and ($SayfalamaIcinSayfaIndexDegeri <= $BulunanSayfaSayisi)) {
                                            if ($Sayfalama == $SayfalamaIcinSayfaIndexDegeri) {
                                                ...
                                                echo "<span class='SayfalamaPasif'><a href='index.php?SK=107" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaIndexDegeri . "'> " . $SayfalamaIcinSayfaIndexDegeri . "</a></span>";
                                            }
                                        }
                                    }
                                    ...
                                    if ($Sayfalama != $BulunanSayfaSayisi) {
                                        ...
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=107" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=107" . $SayfalamaKosulu . "&SYF=" . $BulunanSayfaSayisi . "'>>></a></span>";
                                    }
                                    ?>
                                </div>
                            </div>
